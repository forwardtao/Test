# Generated by Django 2.1.5 on 2019-03-20 18:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='tliublog.Category', verbose_name='分类'),
        ),
        migrations.AddField(
            model_name='article',
            name='tui',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='tliublog.Tui', verbose_name='推荐位'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
